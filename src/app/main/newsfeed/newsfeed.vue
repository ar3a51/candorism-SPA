<template>
  <div class="row">
            <main class="col-xl-12 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-xs-12">
               <candorism-post-form></candorism-post-form>
                <div id="newsfeed-items-grid col-xs-12">
                  <candorism-post></candorism-post>
                  <candorism-post></candorism-post>
                  <!--  <div class="ui-block">
                        ...
                        <article class="hentry post has-post-thumbnail">
                            ...
                            <p>
                                Hey guys! We are gona be playing this Saturday of <a href="#">The Marina Bar</a> for their new Mystic Deer Party.
